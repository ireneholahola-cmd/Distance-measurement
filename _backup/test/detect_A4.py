...
foc = 1810.0       # 根据教程调试相机焦距
real_wid = 11.69   # A4纸横着的时候的宽度，视频拍摄A4纸要横拍，镜头横，A4纸也横
font = cv2.FONT_HERSHEY_SIMPLEX
w_ok = 1

capture = cv2.VideoCapture('A4.mp4')
...
while (True):
    ...
    ret, binary = cv2.threshold(gray, 165, 255, 0)    # 扫描不到纸张轮廓时，要更改阈值，直到方框紧密框住纸张
